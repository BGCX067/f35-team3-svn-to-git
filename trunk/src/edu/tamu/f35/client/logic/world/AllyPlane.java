...
public class AllyPlane extends WorldObject {
	...
	public AllyPlane(double absoluteX, double absoluteY) {
		this(absoluteX, absoluteY, ALLY_SIZE, DEFAULT_SPEED, 180.0);
	}

	protected AllyPlane(double absoluteX, double absoluteY, double size,
	...
	public void step() {
		...
		System.out.println("Ally: (" + twoDForm.format(absoluteX) + ","
	...
	private double calculateSpeed(PlaneObject objectivePlane) {
		...
		if (distToPlane > RadarLogic.DEFAULT_RANGE / 2) {
			return objectivePlane.getSpeed() * 4;
